            ...
            <div>
                <ReactCSSTransitionGroup
                    ...
                    {(this.props.meta.error && this.props.meta.touched)
                        ? (<ErrorText key={this.props.id} id={this.props.id} error={this.props.meta.error} />)
                        : null}
                </ReactCSSTransitionGroup>
                <span className={styles.input}>
                    <span className={styles.icon} onClick={this.toggleVisibility}>{!this.state.passwordVisibility ? <VisibilitySvg /> : <VisibilityOffSvg />}</span>
                    <input
                        {...this.props.input}
